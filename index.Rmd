...
This investigation is important in that it sheds light on one of many factors (biased news) that can impact voting habits of American citizens.  This study is not cross-sectional, since I am not only looking at one point in time. Rather, I am using a "before and after" approach, since I am looking at changes over several years. 
...
The p-value of 0.086 means that affordability of housing is significant in explaining Fox News consumption in a Connecticut town. In terms of whether or not this should be interpreted causally, this study used observational data, not random assignment. We don't know if the relationship is driven solely by affordability, so we cannot interpret causally.

Conclusion: 
  
  There are a few potential confounding variables. For example, urban versus rural, or income of residents in that town connected with family size could be potential confounders. If I had more time and money to complete this analysis, I would filter additional data by political party to see if any registered democrats or independent voters in these towns decided to "vote Republican" after the introduction of Fox News in the area.  
